...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('C:\\wamp\\www\\Symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine' => 'FOS\\UserBundle\\Entity', 'C:\\wamp\\www\\Symfony\\vendor\\egeloen\\google-map-bundle\\Ivory\\GoogleMapBundle\\Resources\\config\\doctrine' => 'Ivory\\GoogleMapBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\wamp\\www\\Symfony\\src\\digit\\synergyBundle\\Entity')), 'digit\\synergyBundle\\Entity');
        $e->addDriver($d, 'FOS\\UserBundle\\Entity');
        $e->addDriver($d, 'Ivory\\GoogleMapBundle\\Entity');
        $e->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array('C:\\wamp\\www\\Symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine\\model' => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('digitsynergyBundle' => 'digit\\synergyBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'IvoryGoogleMapBundle' => 'Ivory\\GoogleMapBundle\\Entity'));
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('digit\\synergyBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('digit\\synergyBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('digit\\synergyBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('digit\\synergyBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'digit\\synergyBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['hwi_oauth.resource_owner.facebook'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\FacebookResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => '854908457858244', 'client_secret' => '2a1884b3c4093a18094733d9355275da', 'paths' => array(), 'options' => array()), 'facebook', $this->get('hwi_oauth.storage.session'));
    }
    ...
    {
        return $this->services['hwi_oauth.resource_owner.google'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\GoogleResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => '204864765480-1qodi5s5f7r5p1a4l4a3fmqnn46fk4dg.apps.googleusercontent.com', 'client_secret' => 'OI5gZni_ZmdvyXnRGI_NjYrz', 'scope' => 'https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile', 'paths' => array(), 'options' => array()), 'google', $this->get('hwi_oauth.storage.session'));
    }
    ...
    {
        $this->services['hwi_oauth.resource_ownermap.main'] = $instance = new \HWI\Bundle\OAuthBundle\Security\Http\ResourceOwnerMap($this->get('security.http_utils'), array(0 => 'facebook', 1 => 'google'), array('facebook' => '/login/check-facebook', 'google' => '/login/check-google'));
     ...
     * This method always returns the same instance of the service.
     *
     * @return digit\synergyBundle\Security\Core\User\FOSUBUserProvider A digit\synergyBundle\Security\Core\User\FOSUBUserProvider instance.
     */
    protected function getMyUserProviderService()
    {
        return $this->services['my_user_provider'] = new \digit\synergyBundle\Security\Core\User\FOSUBUserProvider($this->get('fos_user.user_manager'), array('facebook' => 'facebook_id', 'google' => 'google_id'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $m = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $d, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($d, '/hello'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        $m->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $n = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($d, array('login_path' => '/login', 'default_target_path' => '/hello', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $n->setProviderKey('main');

        $o = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($d, array('login_path' => '/login', 'default_target_path' => '/hello', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $o->setProviderKey('main');

        $p = new \HWI\Bundle\OAuthBundle\Security\Http\Firewall\OAuthListener($b, $f, $g, $d, 'main', $o, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('login_path' => '/login', 'failure_path' => '/login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true), $a, $c);
        $p->setResourceOwnerMap($this->get('hwi_oauth.resource_ownermap.main'));
        $p->setCheckPaths(array(0 => '/login/check-facebook', 1 => '/login/check-google'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($l, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.chain_provider'), 1 => $this->get('security.user.provider.concrete.in_memory'), 2 => $this->get('fos_user.user_provider.username_email')), 'main', $a, $c), 2 => $m, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $g, $d, 'main', $n, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, $this->get('form.csrf_provider')), 4 => $p, 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '53bd88437c24c', $a), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $l, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $d, 'main', new \HWI\Bundle\OAuthBundle\Security\Http\EntryPoint\OAuthEntryPoint($e, $d, '/login', false), NULL, NULL, $a));
    }
     ...
     *
     * @return digit\synergyBundle\admin\AreaAdmin A digit\synergyBundle\admin\AreaAdmin instance.
     */
    protected function getSonata_Admin_CategorieService()
    {
        $instance = new \digit\synergyBundle\admin\AreaAdmin('sonata.admin.categorie', 'digit\\synergyBundle\\Entity\\Area', 'SonataAdminBundle:CRUD');

        $instance->setTranslationDomain('digitsynergyBundle');
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminClasses(array('digit\\synergyBundle\\Entity\\Area' => array(0 => 'sonata.admin.categorie'), 'digit\\synergyBundle\\Entity\\Type' => array(0 => 'sonata.admin.terrain')));
    ...
    {
        return $this->services['sonata.admin.route.cache'] = new \Sonata\AdminBundle\Route\RoutesCache('C:/wamp/www/Symfony/app/cache/dev/sonata/admin', true);
    }
     ...
     *
     * @return digit\synergyBundle\admin\TypeAdmin A digit\synergyBundle\admin\TypeAdmin instance.
     */
    protected function getSonata_Admin_TerrainService()
    {
        $instance = new \digit\synergyBundle\admin\TypeAdmin('sonata.admin.terrain', 'digit\\synergyBundle\\Entity\\Type', 'SonataAdminBundle:CRUD');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.th.xlf', 'th', 'validators');
        ...
        $instance->addResource('xlf', 'C:\\wamp\\www\\Symfony\\src\\digit\\synergyBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ar.yml', 'ar', 'FOSUserBundle');
        ...
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.he.yml', 'he', 'FOSUserBundle');
        ...
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.id.yml', 'id', 'FOSUserBundle');
        ...
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.nb.yml', 'nb', 'FOSUserBundle');
        ...
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.th.yml', 'th', 'FOSUserBundle');
        ...
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.vi.yml', 'vi', 'FOSUserBundle');
        ...
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.ar.yml', 'ar', 'validators');
        ...
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.ca.yml', 'ca', 'validators');
        ...
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.he.yml', 'he', 'validators');
        ...
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.id.yml', 'id', 'validators');
        ...
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.nb.yml', 'nb', 'validators');
        ...
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.ro.yml', 'ro', 'validators');
        ...
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.th.yml', 'th', 'validators');
        ...
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.vi.yml', 'vi', 'validators');
        ...
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\hwi\\oauth-bundle\\HWI\\Bundle\\OAuthBundle/Resources/translations\\HWIOAuthBundle.de.yml', 'de', 'HWIOAuthBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\hwi\\oauth-bundle\\HWI\\Bundle\\OAuthBundle/Resources/translations\\HWIOAuthBundle.en.yml', 'en', 'HWIOAuthBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\hwi\\oauth-bundle\\HWI\\Bundle\\OAuthBundle/Resources/translations\\HWIOAuthBundle.es.yml', 'es', 'HWIOAuthBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\hwi\\oauth-bundle\\HWI\\Bundle\\OAuthBundle/Resources/translations\\HWIOAuthBundle.fr.yml', 'fr', 'HWIOAuthBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\hwi\\oauth-bundle\\HWI\\Bundle\\OAuthBundle/Resources/translations\\HWIOAuthBundle.it.yml', 'it', 'HWIOAuthBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\hwi\\oauth-bundle\\HWI\\Bundle\\OAuthBundle/Resources/translations\\HWIOAuthBundle.nl.yml', 'nl', 'HWIOAuthBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\hwi\\oauth-bundle\\HWI\\Bundle\\OAuthBundle/Resources/translations\\HWIOAuthBundle.pl.yml', 'pl', 'HWIOAuthBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\hwi\\oauth-bundle\\HWI\\Bundle\\OAuthBundle/Resources/translations\\HWIOAuthBundle.ru.yml', 'ru', 'HWIOAuthBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\hwi\\oauth-bundle\\HWI\\Bundle\\OAuthBundle/Resources/translations\\HWIOAuthBundle.tr.yml', 'tr', 'HWIOAuthBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.bg.xliff', 'bg', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.ca.xliff', 'ca', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.cs.xliff', 'cs', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.de.xliff', 'de', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.en.xliff', 'en', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.es.xliff', 'es', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.eu.xliff', 'eu', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.fa.xliff', 'fa', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.fr.xliff', 'fr', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.hr.xliff', 'hr', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.hu.xliff', 'hu', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.it.xliff', 'it', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.ja.xliff', 'ja', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.lb.xliff', 'lb', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.lt.xliff', 'lt', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.nl.xliff', 'nl', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.pl.xliff', 'pl', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.pt.xliff', 'pt', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.pt_BR.xliff', 'pt_BR', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.ro.xliff', 'ro', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.ru.xliff', 'ru', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.sk.xliff', 'sk', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.sl.xliff', 'sl', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.uk.xliff', 'uk', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.zh_CN.xliff', 'zh_CN', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.bg.xliff', 'bg', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.ca.xliff', 'ca', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.cs.xliff', 'cs', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.de.xliff', 'de', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.en.xliff', 'en', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.es.xliff', 'es', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.eu.xliff', 'eu', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.fa.xliff', 'fa', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.fr.xliff', 'fr', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.hr.xliff', 'hr', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.hu.xliff', 'hu', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.it.xliff', 'it', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.ja.xliff', 'ja', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.lb.xliff', 'lb', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.lt.xliff', 'lt', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.nl.xliff', 'nl', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.pl.xliff', 'pl', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.pt.xliff', 'pt', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.pt_BR.xliff', 'pt_BR', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.ro.xliff', 'ro', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.ru.xliff', 'ru', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.sk.xliff', 'sk', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.sl.xliff', 'sl', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.uk.xliff', 'uk', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.zh_CN.xliff', 'zh_CN', 'SonataAdminBundle');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\Symfony\\src\\digit\\synergyBundle/Resources/views', 'digitsynergy');
        $instance->addPath('C:\\wamp\\www\\Symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/views', 'FOSUser');
        $instance->addPath('C:\\wamp\\www\\Symfony\\vendor\\hwi\\oauth-bundle\\HWI\\Bundle\\OAuthBundle/Resources/views', 'HWIOAuth');
        $instance->addPath('C:\\wamp\\www\\Symfony\\vendor\\egeloen\\google-map-bundle\\Ivory\\GoogleMapBundle/Resources/views', 'IvoryGoogleMap');
        $instance->addPath('C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\core-bundle/Resources/views', 'SonataCore');
        $instance->addPath('C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\block-bundle/Resources/views', 'SonataBlock');
        $instance->addPath('C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\doctrine-orm-admin-bundle/Resources/views', 'SonataDoctrineORMAdmin');
        $instance->addPath('C:\\wamp\\www\\Symfony\\vendor\\sonata-project\\admin-bundle/Resources/views', 'SonataAdmin');
        ...
        $instance->addPath('C:\\wamp\\www\\Symfony\\vendor\\knplabs\\knp-menu\\src\\Knp\\Menu/Resources/views');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('6899412df48b10a15a5d52a5236df3981');
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('user', 'admin', array(0 => 'ROLE_USER')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'digitsynergyBundle' => 'digit\\synergyBundle\\digitsynergyBundle',
            ...
            'locale' => 'en',
            'secret' => '6899412df48b10a15a5d52a5236df3981',
            'facebook_app_id' => '854908457858244',
            'facebook_app_secret' => '2a1884b3c4093a18094733d9355275da',
            'google_app_id' => '204864765480-1qodi5s5f7r5p1a4l4a3fmqnn46fk4dg.apps.googleusercontent.com',
            'google_app_secret' => 'OI5gZni_ZmdvyXnRGI_NjYrz',
            'database_path' => NULL,
            'my_user_provider.class' => 'digit\\synergyBundle\\Security\\Core\\User\\FOSUBUserProvider',
            ...
            'kernel.secret' => '6899412df48b10a15a5d52a5236df3981',
            ...
            'fos_user.model.user.class' => 'digit\\synergyBundle\\Entity\\User',
